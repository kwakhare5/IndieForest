...
export function SegmentedControl<T extends string | number>({
  ...
  const sizeStyles = {
    sm: "py-1 px-2.5 text-[11px] gap-1",
      ...
      {options.map((opt) => {
        ...
        return (
          <button
            ...
            className={`flex-1 rounded-full font-semibold transition-all duration-150 flex items-center justify-center cursor-pointer select-none ${sizeStyles} ${
              isSelected
                ? "bg-white text-stone-950 shadow-[0_2px_8px_-2px_rgba(68,64,60,0.12),inset_0_1px_1px_rgba(255,255,255,1)] border border-stone-200/80 font-bold scale-[1.01]"
